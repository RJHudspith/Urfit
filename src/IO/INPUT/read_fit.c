	     ...
	     const size_t Ntags )
{
  ...
  } else if( are_equal( Flat[tag].Value , "FVOL4" ) ) {
    Input -> Fit.Fitdef = FVOL4 ;
  } else if( are_equal( Flat[tag].Value , "FVOL5" ) ) {
    Input -> Fit.Fitdef = FVOL5 ;
  } else if( are_equal( Flat[tag].Value , "FVOL6" ) ) {
    Input -> Fit.Fitdef = FVOL6 ;
