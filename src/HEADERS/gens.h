...
// fit types
typedef enum {
  ALPHA_D0 , ALPHA_D0_MULTI , ADLERALPHA_D0 , ADLERALPHA_D0_MULTI , HALEXP , EXP , EXP_XINV , COSH , EXP_PLUSC , HLBL_CONT , NRQCD_EXP , NRQCD_EXP2 , NOFIT , PADE , PEXP , POLY , PP_AA , PP_AA_WW , PP_AA_WW_R2 , PP_AA_EXP , PPAA , QCORR_BESSEL , QSUSC_SU2 , SINH , TANH , POLES , QSLAB , QSLAB_FIXED , CORNELL , FVOL1 , FVOL2 , FVOL3 , UDCB_HEAVY , C4C7 , SOL , SU2_SHITFIT , SUN_CONT , ZV_EXP
} fittype ;
